...
namespace PWT::UI {
    class ActionsTab final: public ScrollableTab {
        Q_OBJECT

    private:
        QPushButton *importProfilesBtn = nullptr;
        QComboBox *exportProfileList = nullptr;
        QPushButton *exportProfileBtn = nullptr;
