...
namespace PWT::UI::LNX {
    class CPUFrequencyGBox final: public QGroupBox {
        Q_OBJECT
    ...
    private:
        ...
        SliderUnitWidget *minAll = nullptr;
        SliderUnitWidget *maxAll = nullptr;
        QComboBox *cpuSelect = nullptr;
        SliderUnitWidget *minFreq = nullptr;
        SliderUnitWidget *maxFreq = nullptr;
        QList<WData> data;
    ...
    public:
        explicit CPUFrequencyGBox(int threadCount);
