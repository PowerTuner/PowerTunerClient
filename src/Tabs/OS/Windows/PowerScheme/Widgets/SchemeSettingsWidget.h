...
#include "../Include/PowerSettingGBox.h"
...
namespace PWT::UI::WIN {
    ...
    private:
        ...
        QHash<QString, QSharedPointer<SettingItm>> settingGBoxMap;
        QList<QSharedPointer<SettingItm>> settingItmList;
        mutable QList<QSharedPointer<SettingItm>> pageItmList;

        [[nodiscard]] bool isSettingVisible(const QString &filter, const PowerSettingGBox *gbox) const;
