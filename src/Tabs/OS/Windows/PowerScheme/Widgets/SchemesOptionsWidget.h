...
#include "SchemeOptionsWidgets/MiscGlobalOptionsGBox.h"
#include "SchemeOptionsWidgets/CopySchemeSettingsGBox.h"
#include "SchemeOptionsWidgets/DuplicateSchemeGBox.h"
#include "SchemeOptionsWidgets/SchemeActionsGBox.h"
...
namespace PWT::UI::WIN {
    ...
    private:
        QLabel *currentLbl = nullptr;
        MiscGlobalOptionsGBox *miscGlobalOptsGBox = nullptr;
        CopySchemeSettingsGBox *copySchemeSettingsGBox = nullptr;
        DuplicateSchemeGBox *duplicateSchemeGBox = nullptr;
        SchemeActionsGBox *schemeActionsGBox = nullptr;
