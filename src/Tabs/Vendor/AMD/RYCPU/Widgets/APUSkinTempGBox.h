...
namespace PWT::UI::AMD {
    class APUSkinTempGBox final: public RADJSliderGBox {
    public:
        explicit APUSkinTempGBox(const bool hasReadFeature): RADJSliderGBox("Smart Temperature Tracking APU (STT APU)",
                                            "APU Skin Temperature Limit",
                                            "°C",
