...
namespace PWT::UI::AMD {
    class VRMMaxCurrentGBox final: public SliderLimitGBox {
    public:
        VRMMaxCurrentGBox(): SliderLimitGBox("Electrical Design Current Limit (EDC VDD)",
        ...
        void setData(const PWTS::DaemonPacket &packet) override {
            ...
            const int val = packet.amdData->vrmMaxCurrent.getValue();
        ...
        void setDataForPacket(const PWTS::ClientPacket &packet) const override {
            ...
            packet.amdData->vrmMaxCurrent.setValue(slider->getValue(), true);
        }
    };
}
