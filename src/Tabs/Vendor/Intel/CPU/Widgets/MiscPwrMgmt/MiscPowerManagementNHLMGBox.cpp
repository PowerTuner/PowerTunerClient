 ...
 */
#include "MiscPowerManagementNHLMGBox.h"
#include "../../../../../Include/FlowLayout.h"
#include "pwtClientCommon/UILogger.h"

namespace PWT::UI::INTEL {
    MiscPowerManagementGBoxNHLM::MiscPowerManagementGBoxNHLM() {
        FlowLayout *lyt = new FlowLayout();

        eist = new QCheckBox("Disable EIST (Enhanced SpeedStep) hardware coordination");
    ...
    void MiscPowerManagementGBoxNHLM::setData(const PWTS::DaemonPacket &packet) {
    ...
    void MiscPowerManagementGBoxNHLM::setDataForPacket(const PWTS::ClientPacket &packet) const {
        if (!isEnabled())
            return;
