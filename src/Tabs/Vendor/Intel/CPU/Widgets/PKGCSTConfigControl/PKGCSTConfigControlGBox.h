...
namespace PWT::UI::INTEL {
    class PKGCSTConfigControlGBox final: public QGroupBox {
        Q_OBJECT
    ...
    private:
        ...
        PKGCSTConfigControlWidget *pkgCstCfgControlWidget = nullptr;
    ...
    public:
        PKGCSTConfigControlGBox(int coreCount, const QSet<PWTS::Feature> &features);
