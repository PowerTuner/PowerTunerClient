...
#include "Widgets/PkgRaplLimit/PkgRaplLimitGBox.h"

namespace PWT::UI::INTEL {
    class MCHBARTab final: public AddonTab {
    private:
        QPointer<PkgRaplLimitGBox> pkgRaplLimitGBox;

    public:
        explicit MCHBARTab(const PWTS::DeviceInfoPacket &packet);
